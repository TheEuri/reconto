...
public class TelaInicialGUI {
  ...
  public TelaInicialGUI () {
    SwingUtilities.invokeLater(() -> {
      ...
      ImageIcon imgIcon = new ImageIcon("src/assets/logo1.png");
      ...
      ImageIcon img2Icon = new ImageIcon("src/assets/img1.png");
      ...
      ImageIcon img3Icon = new ImageIcon("src/assets/img2.png");
