...
public class TelaDescartesGUI extends JFrame {
  ...
  private JPanel descartesPanel; 
    ...
    private JPanel createFirstBlock(Cliente cliente) {
        ...
        JLabel logoLabel = createImageLabel("src/assets/logo4.png", 92, 70);
    ...
    private JPanel createItemBlock(String title, String address, String status, String brand, String codAut) {
        ...
        JLabel iconLabel = createImageLabel("src/assets/seta.png", 16, 16);
        ...
        if (status.equals("Concluído")) {
            statusIconLabel = createImageLabel("src/assets/confirmado.png", 16, 16);
        } else {
            statusIconLabel = createImageLabel("src/assets/pendente.png", 16, 16);
        }
        ...
        JLabel imageLabel = createImageLabel("src/assets/img4.png", 100, 100);
